...
/// @title BPianoVerifierTest
/// @notice Forge 集成测试：读取 Go 生成的 fixture.json，验证 BPiano 证明。
contract BPianoVerifierTest is Test {
    ...
    function test_Verify() public {
        ...
        assertTrue(ok, "BPianoVerifier.verify should return true");
    }
