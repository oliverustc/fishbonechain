...
import {BPianoVerifierGen} from "../src/BPianoVerifierGen.sol";
import {Pairing} from "../src/Pairing.sol";

/// @title BPianoVerifierGenTest
/// @notice Forge 集成测试：读取 Go 生成的 fixture.json，验证 BPianoVerifierGen（VK 硬编码版）。
contract BPianoVerifierGenTest is Test {
    using stdJson for string;

    BPianoVerifierGen internal verifier;
    ...
    function setUp() public {
        verifier = new BPianoVerifierGen();
    }
    ...
    function test_VerifyGen() public {
        ...
        BPianoVerifierGen.CompressedProof memory proof;
        ...
        emit log_named_uint("BPiano1 gas", g0 - gasleft());
        assertTrue(ok, "BPianoVerifierGen.verify should return true");
    }
