...
> 口径说明：隔离列的 100% 表示场景独享子链容量，不再被其他场景挤占；它不是宣称长期运行中完全没有链上约束拒绝。详细说明见 `docs/isolation-experiment.md`。
...
> 详细口径、原始数据位置与复现命令见 `docs/capacity-experiment.md`。
...
| `docs/figures/data/exp_capacity_summary.csv` | MaxSubmissions=10000 容量实验汇总 |
| `docs/figures/data/exp_isolation_summary.csv` | 跨场景隔离对比数据 |
| `docs/figures/data/exp_liquidity_horizon_summary.csv` | T=3/10/20 资金锁定对比数据 |
...
| `docs/figures/fig_capacity_scaling.png` | 最大吞吐扩展能力 |
| `docs/figures/fig_isolation_comparison.png` | 跨场景隔离效果对比 |
