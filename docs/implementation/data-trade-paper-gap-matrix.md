...
| Root obfuscation proof | `RootObfuscationProof` exists and artifacts include `ro_depth10` proof files | `partially-supported` | `tools/data-trade-zk/internal/gnarkadapter/root_obfuscation.go` | Simplified RO proof; not full four-layer IMT membership | Full IMT membership coupling |
