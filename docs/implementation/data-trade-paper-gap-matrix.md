...
| Circuit-level range business witness | `BusinessRangeProof` proves range, masked value relation, MiMC masked commitment | `implemented` | `tools/data-trade-zk/internal/gnarkadapter/business_range_proof.go` | Only range; fixture data static | Dynamic witness and more constraints |
