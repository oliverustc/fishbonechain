...
| Circuit-level range business witness | `BusinessRangeProof` proves range, masked value relation, MiMC masked commitment; Stage 8 dynamic witnesses; Stage 10 `multi_range` conjunction supports multi-field range AND | `implemented` | `tools/data-trade-zk/internal/gnarkadapter/business_range_proof.go`, `internal/dynamic/witness.go` | Dynamic multi-field/multi-record range; not subset/substr or aggregate proof | Subset/substr constraints, on-chain aggregate proof |
