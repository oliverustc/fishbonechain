...
- [implementation/offchain-job-executor.md](implementation/offchain-job-executor.md)：链下任务执行器（Stage 19，无依赖 Node.js 单次执行 CLI，proof_generation 任务执行，dry-run 与真实验证分离，Evidence 自动创建）
