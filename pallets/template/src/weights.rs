...
//! Autogenerated weights for pallet_fishbone_template
//!
...
/// Weight functions needed for pallet_fishbone_template.
pub trait WeightInfo {
	fn do_something() -> Weight;
	fn cause_error() -> Weight;
}

/// Weights for pallet_fishbone_template using the Substrate node and recommended hardware.
